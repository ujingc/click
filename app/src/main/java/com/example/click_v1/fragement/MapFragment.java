...
//import com.example.click_v1.googleMapUtilsuserListener.BoundariesListener;
import com.example.click_v1.adapters.UsersAdapter;
import com.example.click_v1.googleMapUtils.OwnIconRendered;
...
//        BoundariesListener boundariesListener = new BoundariesListener(googleMap);
...
//        mMap.setOnCameraIdleListener(boundariesListener);
    ...
    private void setupData() {
        ...
        user1.id = "7bzxYJzJn1gqM3AagXIk";


        String creatorId2 = "7bzxYJzJn1gqM3AagXIk";
        String id2 = "2";
        String topic2 = "运动";
        String title2 = "打羽毛球";
        String description2 = "组团打羽毛球";
        double lat2 = -34.01;
        double lng2 = 151.02;
        ...
        user2.id = "RT5XVxgM3mf53TotI5bA";

        MarkerActivity markerActivity1 = new MarkerActivity();
        markerActivity1.setCreatorId(creatorId);
        markerActivity1.setId(id);
        markerActivity1.setTopic(topic);
        markerActivity1.setTitle(title);
        markerActivity1.setDescription(description);
        markerActivity1.setLat(lat);
        markerActivity1.setLng(lng);
        markerActivity1.setDateObject(dateTime);
        markerActivity1.setCreatorName("avatar");
        markerActivity1.setCreatorId("7bzxYJzJn1gqM3AagXIk");
        markerActivity1.setCreatorImage("");

        MarkerActivity markerActivity2 = new MarkerActivity();
        markerActivity2.setCreatorId(creatorId2);
        markerActivity2.setId(id2);
        markerActivity2.setTopic(topic2);
        markerActivity2.setTitle(title2);
        markerActivity2.setDescription(description2);
        markerActivity2.setLat(lat2);
        markerActivity2.setLng(lng2);
        markerActivity2.setDateObject(dateTime2);
        markerActivity2.setCreatorName("Neytiri");
        markerActivity2.setCreatorId("RT5XVxgM3mf53TotI5bA");
        markerActivity2.setCreatorImage("");

        markerActivities.add(markerActivity1);
        markerActivities.add(markerActivity2);
    }
...
//    private void listenMarkerActivity() {
//        database.collection(Constants.KEY_COLLECTION_ACTIVITY)
...
//        if (value != null) {
//            int count = markerActivities.size();
...
//                    MarkerActivity markerActivity = new MarkerActivity();
//
//                    markerActivity.setCreatorId(documentChange.getDocument().getString(Constants.KEY_CREATOR_ID));
//                    markerActivity.setId(documentChange.getDocument().getString(Constants.KEY_ID));
//                    markerActivity.setTopic(Constants.KEY_ID);
//                    markerActivity.setTitle(title2);
//                    markerActivity.setDescription(description2);
//                    markerActivity.setLat(lat2);
//                    markerActivity.setLng(lng2);
//                    markerActivity.setDateTime(dateTime2);
//                    markerActivity.setUser(user2);
//
//
//
...
//                hoursText.setText(String.valueOf(hours));
    ...
    private void listenToMarkerActivityChange() {
//        scope.launch {

...
//        });
    ...
    private void addItems() {
        for (MarkerActivity markerActivity : markerActivities) {
            Date now = new Date();
            Long countDownLeftTime = getDateDiff(markerActivity.dateTime, now, TimeUnit.MILLISECONDS);
